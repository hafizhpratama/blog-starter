...
<table>
  ...
  <tbody>
    <tr>
      <td>Go</td>
      <td>1835ms</td>
      <td>1872, 2013, 1893, 1690, 1886</td>
      <td>1870ms</td>
    </tr>
    <tr>
      <td>Java</td>
      <td>2322ms</td>
      <td>2611, 2128, 2101, 1914, 1753</td>
      <td>2101ms</td>
    </tr>
    <tr>
      <td>Rust</td>
      <td>2459ms</td>
      <td>2505, 2321, 2376, 2309, 2405</td>
      <td>2383ms</td>
    </tr>
  </tbody>
</table>

_Note: All tests were run on Programiz online compiler (https://www.programiz.com/). Each implementation successfully found 664,579 prime numbers up to 10,000,000 across all iterations._
...
- **Go (1870ms)**:
  ...
  - Konsistensi yang sangat baik antar iterasi
  - Overhead scheduling tetap minimal
  - Memory management yang efisien

- **Java (2101ms)**:

  - Performa kompetitif setelah warm-up
  - JIT optimization bekerja efektif
  - Thread pool management yang matang
  - Variance lebih tinggi antar iterasi
