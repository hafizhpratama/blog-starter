...
export const PROJECTS: Project[] = [
  {
    title: "IntentJS",
    description:
      "It is like Laravel, But for NodeJS.  A refreshing take on traditional nodejs frameworks, change the way you build your products. Intent is an open-source framework with focus on productivity and developer experience.",
    tags: ["IntentJS"],
  ...
  },
  {
    ...
    description:
      "Seamlessly handles recruitment, candidate management, attendance tracking, employee administration, and payroll processing.",
...
export const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Driving innovation at Surplus Indonesia as a software engineer, building solutions that cut costs and scale impact!",
  ...
  },
  {
    ...
    description:
      "Led a team at Sirclo, streamlining dev, delivering core solutions, and launching a multi-seller feature!",
  ...
  },
  {
    ...
    description:
      "At Hukumonline, I drove digital transformation, launching key sites and innovating CMS with API integration!",
