...
const ExperienceSection = memo(function ExperienceSection({ experiences }: { experiences: Experience[] }) {
    ...
    <div className="mt-24 mb-16">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-serif italic">Work Experience</h2>
